    ...
    <section class="section-spacing" data-section="about" id="about">
      <div class="section-shell grid gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-center">
        <div class="relative" data-reveal="left">
          ...
          <div class="texture-card overflow-hidden rounded-[2.5rem] p-4 sm:p-5">
            <img
              alt="Bakery team preparing dough and pastries"
              class="h-full min-h-[520px] w-full rounded-[2rem] object-cover"
        ...
        <div class="space-y-8">
          ...
          <div class="grid gap-4" data-reveal style={{ "--reveal-delay": "120ms" }}>
            <For each={storyPoints}>
              {point => (
                <div class="glass-panel rounded-[1.75rem] p-5">
                  <p class="text-base leading-7 text-[var(--color-mocha)]">{point}</p>
                </div>
              )}
            </For>
          </div>
          ...
          >
            <div>
              <p class="font-display text-4xl text-[var(--color-espresso)]">5 AM</p>
              <p class="mt-2 text-sm uppercase tracking-[0.25em] text-[var(--color-mocha)]">
                Ovens begin warming before sunrise.
              </p>
            </div>
            <div>
              <p class="font-display text-4xl text-[var(--color-espresso)]">100%</p>
              <p class="mt-2 text-sm uppercase tracking-[0.25em] text-[var(--color-mocha)]">
