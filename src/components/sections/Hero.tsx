...
export default function Hero() {
  return (
    <section class="page-shell overflow-hidden pt-28 sm:pt-32" data-section="home" id="home">
        ...
        <div class="space-y-10">
          <div class="space-y-6" data-reveal>
            ...
            <p class="max-w-2xl text-lg leading-8 text-[var(--color-mocha)] sm:text-xl">
              Le Petit Oven blends French pastry discipline with a cozy neighborhood rhythm, serving
              handcrafted viennoiserie, seasonal cakes, and naturally leavened breads in a refined,
              welcoming setting.
            </p>
          </div>
          ...
          >
            <For each={bakeryStats}>
              {stat => (
                <div class="space-y-1">
                  <p class="font-display text-4xl text-[var(--color-espresso)]">{stat.value}</p>
          ...
          <div class="texture-card relative overflow-hidden rounded-[2.5rem] p-4 sm:p-6">
            <div class="grid gap-4 lg:grid-cols-[1.1fr_0.9fr]">
              <div class="overflow-hidden rounded-[2rem] bg-[#f0e2d0]">
                <img
                  alt="Illustrated bakery counter with bread and pastries"
              ...
              <div class="flex flex-col gap-4">
                <div class="overflow-hidden rounded-[2rem] bg-[#f6e9d7]">
                  <img
                    ...
                    src="/images/hero-pastries.svg"
                  />
                </div>
                <div class="glass-panel rounded-[2rem] p-6">
                  <div class="flex items-center gap-3 text-[var(--color-caramel)]">
                    <Sparkles class="size-5" />
                    <p class="text-sm font-semibold uppercase tracking-[0.3em]">Today's Ritual</p>
                  </div>
